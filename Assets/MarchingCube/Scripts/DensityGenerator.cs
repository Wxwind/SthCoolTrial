...
namespace MarchingCube.Scripts
{
    ...
    public class DensityGenerator:MonoBehaviour
    {
        ...
        public ComputeBuffer Generate(ComputeBuffer pointsBuffer,int numPointsPerAxis,float chunkSize,Vector3 center,Vector3 offset,float voxelSize,Vector3 worldBounds)
        {
